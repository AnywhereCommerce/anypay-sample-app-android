...
import com.anywherecommerce.android.sdk.models.CardholderVerificationMethod;
...
public class SampleKeyedSaleTransaction {

    public static GenericEventListener signatureRequiredListener;

    public static void execute(final TransactionListener mainActivityCallback)
    {
        ...
        // OPTIONAL:  If you want to prompt the user for a signature,
        //            set this to SIGNATURE and the onSignatureRequired callback will be invoked after authorization.
        //            Otherwise, if you do not want a signature, set it to NONE and the callback will be skipped.
        transaction.setCardholderVerificationMethod(CardholderVerificationMethod.SIGNATURE);
        ...
        transaction.setOnWarningListener(new MeaningfulMessageListener() {
            ...
            public void onMessage(MeaningfulMessage message) {
                ...
                // TODO - Notify user or take some custom action.
            }
        });
        */
