...
import com.anywherecommerce.android.sdk.transactions.EmvTransaction;
...
public class SampleEmvSaleTransaction {
    ...
    public static void executeUsingCardReader(CardReader reader, final TransactionListener  mainActivityCallback)
    {
        ...
        final EmvTransaction transaction = new WorldnetTransaction();
